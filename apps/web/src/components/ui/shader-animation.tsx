...
const ShaderAnimation = ({
  ...
  useEffect(() => {
    ...
    const fragmentShaderSource = `
      ...
      // KicksMtaani colors: red/orange theme
      ...
      void main() {
        ...
        // Red/orange gradient for KicksMtaani branding
        vec3 gradient1 = vec3(0.1, 0.0, 0.0);
        vec3 gradient2 = vec3(0.9, 0.2, 0.1);
    ...
    <div className={`relative w-full h-full overflow-hidden ${className}`}>
      ...
      {interactive && (
        <button
          ...
          className="absolute bottom-4 right-4 z-20 px-3 py-1.5 bg-white/10 backdrop-blur-sm text-white text-xs rounded-full border border-white/20 hover:bg-white/20 transition-colors"
        >
